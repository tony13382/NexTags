...
def _audio_details_from_tags(
    ...
    return {
        ...
        "TrackNumber": _tag_to_string(tags.get('tracknumber', ''), 'tracknumber'),
        "TrackTotal": _tag_to_string(tags.get('tracktotal', ''), 'tracktotal'),
...
def _extract_audio_details_sync(file_path: str, allow_folders: List[str]) -> dict:
    ...
    try:
        ...
        return {
            ...
            "TrackNumber": tag_to_string(tags.get('tracknumber', ''), 'tracknumber'),
            "TrackTotal": tag_to_string(tags.get('tracktotal', ''), 'tracktotal'),
